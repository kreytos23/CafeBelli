...
public class PanelTamaño extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        add(tipoDeLecheTex);
        tipoDeLecheTex.setBounds(40, 80, 130, 50);
        ...
        tamañoDelCafeTex.setBounds(40, 240, 160, 50);
        ...
        comboTipoDeLeche.setBounds(240, 90, 100, 26);
        ...
        add(comboTamanio);
        comboTamanio.setBounds(240, 250, 100, 26);
        ...
        add(letreroTitulo);
        letreroTitulo.setBounds(73, 20, 230, 50);

        tipoDeLecheJL.setText("jLabel4");
        add(tipoDeLecheJL);
        tipoDeLecheJL.setBounds(140, 130, 110, 100);

        tamañoDelCafeJL.setText("jLabel5");
        add(tamañoDelCafeJL);
        tamañoDelCafeJL.setBounds(140, 300, 110, 100);
    ...
    private void comboTipoDeLecheActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_comboTipoDeLecheActionPerformed
        ...
        System.out.println(comboTipoDeLeche.getSelectedItem().toString());
